...
$insert = "INSERT INTO users VALUES
	('1','admin','admin','admin','{$passwords[0]}','{$avatarUrl}admin.jpg', NOW(), '0'),
	('2','Gordon','Brown','gordonb','{$passwords[1]}','{$avatarUrl}gordonb.jpg', NOW(), '0'),
	('3','Hack','Me','1337','{$passwords[2]}','{$avatarUrl}1337.jpg', NOW(), '0'),
	('4','Pablo','Picasso','pablo','{$passwords[3]}','{$avatarUrl}pablo.jpg', NOW(), '0'),
	('5','Bob','Smith','smithy','{$passwords[4]}','{$avatarUrl}smithy.jpg', NOW(), '0');";
